...
class Settings:
    ...
    def __post_init__(self):
        object.__setattr__(self, "referral_url_prefix", f"https://t.me/{self.official_bot_username}?start=")
...
def load_settings() -> Settings:
    ...
    return Settings(
        bot_token=bot_token, admin_ids=_parse_admin_ids(admin_raw), api_id=int(api_id), api_hash=api_hash,
        telethon_session=session_path, database_url=database_url,
